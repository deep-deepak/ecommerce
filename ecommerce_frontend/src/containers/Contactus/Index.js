                            ...
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="form-group">
                                        <input type="text" className="form-control" id="name" name="name" placeholder="Your Name" required data-error="this is the required field"/>
                                ...
                                <div className="col-md-12">
                                    ...
                                    <div className="submit-button text-center">
                                        <button className="btn hvr-hover"  style={{color:"darkred"}} id="submit" type="submit">Send Message</button>
