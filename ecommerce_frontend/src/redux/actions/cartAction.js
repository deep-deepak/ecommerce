/***
 * cartActions stores the information of  what needs to be done.
 */
...
export const addToCart = (id, qty) => async (dispatch, getState) => {
    ...
    alert('Error in addToCard: ' + error)
}
}
...
export const removeFromCart = (id) => (dispatch, getState) => {
    ...
    alert('Error in removeFromCart: ' + error)
}
}
// save the shipping address given by customer
